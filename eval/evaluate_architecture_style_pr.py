...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_name", type=str, default='wegs_VanillaCLIPExtUncetainDM-T-100epoch_catFeature12dReconUncertainlyTMAM30Kiter_trevi_fountain')
    parser.add_argument('--feat_dir', type=str, default='/home/wangyz/Documents/projects/0working/langsplat-w/output/wegs_VanillaCLIPExtUncetainDM-T-100epoch_catFeature12dReconUncertainlyTMAM30Kiter_trevi_fountain')
